...
```
  ...
  To load the picture in full size it is needed the attribute "**data-src_**andsomething".
  The attribute "**data-href_**andsomething" is useful in case you like to direct the link to e.g., LIVEPREVIEW
